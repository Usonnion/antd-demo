...
export default class NoticeIcon extends PureComponent {
  static defaultProps = {
    ...
    emptyImage: 'https://gw.alipayobjects.com/zos/rmsportal/empyNoticeIcon.svg',
  };
  static Tab = TabPane;
  constructor(props) {
    super(props);
  ...
  getNotificationBox() {
    ...
    const actualChilren = children.map ? children : [children];
    const panes = actualChilren.map((child) => {
